		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Connection",
									"targetURL": "#syncproject0502-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncproject0502-display": {
								"semanticObject": "syncproject0502",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.project0502",
									"url": sap.ui.require.toUrl("sync/project0502")
								}
							}
						}
					}
