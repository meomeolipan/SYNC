		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Router",
									"targetURL": "#syncproject0512-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncproject0512-display": {
								"semanticObject": "syncproject0512",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.project0512",
									"url": sap.ui.require.toUrl("sync/project0512")
								}
							}
						}
					}
