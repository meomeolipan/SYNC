		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Product Program (05)",
									"targetURL": "#examexprogram05-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"examexprogram05-display": {
								"semanticObject": "examexprogram05",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=exam.exprogram05",
									"url": sap.ui.require.toUrl("exam/exprogram05")
								}
							}
						}
					}
