		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UX410 문제",
									"targetURL": "#sapbtpux410solvingself-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpux410solvingself-display": {
								"semanticObject": "sapbtpux410solvingself",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.ux410solvingself",
									"url": sap.ui.require.toUrl("sap/btp/ux410solvingself")
								}
							}
						}
					}
